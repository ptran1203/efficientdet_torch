...
parser.add_argument(
    "-o", "--min-overlap", nargs="+", type=float, help="Min overlap",
)
...
MINOVERLAP = args.min_overlap[0] or 0.4

print(f"Evaluate at IOU threshold {MINOVERLAP}")
...
GT_PATH = "./evaluation/input/ground-truth"
DR_PATH = "./evaluation/input/detection-results"
...
import json
with open(output_files_path + "/mAP.json", "w") as f:
    json.dump(ap_dictionary, f, indent=4)
